    ...
    stage('DefectDojoPublisher') {
      steps {
        withCredentials([string(credentialsId: 'DEFECT_DOJO_KEY', variable: 'API_KEY')]) {
          defectDojoPublisher(artifact: 'results.json', productName: 'SDL6', scanType: 'Dependency Check Scan', engagementName: 'ci/cd', defectDojoCredentialsId: 'e423bc1971dfb2666b5166a2dded5d39aeeded2b', sourceCodeUrl: 'https://github.com/AlexDemokidov/sdl6.git', branchTag: 'main')
        }
      }
    }
  }
